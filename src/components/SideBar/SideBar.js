...
function SideBar(props) {
    ...
    props.filterItems.forEach(filterItem => {
        locationsCopy.forEach(location => {
            location.checkAll = 0
            // console.log(location.avg_rating)
            console.log(Object.keys(filterItem))
            // if (Object.keys(filterItem)[0] === 'USA' || Object.keys(filterItem)[0] === 'UK' || Object.keys(filterItem)[0] === 'Canada') {
    ...
    props.filterItems.forEach(filterItem => {
        filteredByCountry.forEach(location => {
            // if (Object.keys(filterItem)[0] === 'fiveStars' || Object.keys(filterItem)[0] === 'fourStars' || Object.keys(filterItem)[0] === 'threeStars' || Object.keys(filterItem)[0] === 'twoStars' || Object.keys(filterItem)[0] === 'oneStar') {
                let ratingNumber = 0
    ...
    props.filterItems.forEach(filterItem => {
        filteredByRating.forEach(location => {
            // if (Object.keys(filterItem)[0] === 'Facebook' || Object.keys(filterItem)[0] === 'GoogleAnalytics' || Object.keys(filterItem)[0] === 'GoogleMyBusiness' || Object.keys(filterItem)[0] === 'InfusionSoft' || Object.keys(filterItem)[0] === 'Twitter' || Object.keys(filterItem)[0] === 'YouTube' || Object.keys(filterItem)[0] === 'LinkedIn'){
